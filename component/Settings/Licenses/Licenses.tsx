  ...
  return (
    <div className={styles.licenses}>
      <Type name="altoBold" className={styles.header}>
        ...
        <Type name="altoBook" className={styles.pretext}>
          For third-party software that you receive from Spotify which is
          licensed under a license that gives you the right to receive the
          source code, <br /> you can obtain a copy at this website:
